    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoresProducts", x => new { x.StoreId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMangeUsers", x => new { x.ApplicationUserId, x.EmployeeId });
                    table.ForeignKey(
                        name: "FK_UserMangeUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserMangeUsers_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMangeUsers_EmployeeId",
                table: "UserMangeUsers",
                column: "EmployeeId");
        }
